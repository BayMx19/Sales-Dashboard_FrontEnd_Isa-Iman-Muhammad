...
!(function (o) {
    ...
    o('.side-nav').length &&
      ...
      o('.side-nav a').each(function () {
        ...
        this.href == e &&
          ...
          'sidebar-menu' !==
            (e = o(this).parent().parent().parent().parent().parent().parent()).attr('id') &&
            e.addClass('show'),
          o(this)
            .parent()
            .parent()
  ...
  ;(e(),
    ...
    jQuery().daterangepicker &&
      ...
      (c = { cancelClass: 'btn-light', applyButtonClasses: 'btn-success' }),
      o('[data-toggle="date-picker"]').each(function (e, t) {
        var n = o.extend({}, c, o(t).data())
        o(t).daterangepicker(n)
      })),
    jQuery().timepicker &&
      ((c = { showSeconds: !0, icons: { up: 'mdi-chevron-up', down: 'mdi-chevron-down' } }),
          ...
          var n = this,
            e =
              ...
              document.querySelectorAll('input[name=data-layout]').forEach(function (t) {
                t.addEventListener('change', function (e) {
                  window.location =
                    'horizontal' === t.value ? 'layouts-horizontal.php' : 'index.php'
                })
              }),
        ...
        value: function () {
          ...
          s &&
            ...
            (n = document.querySelector(
              'input[type=checkbox][name=data-layout-mode][value=' + s.layout.mode + ']',
            )),
            (a = document.querySelector(
              'input[type=checkbox][name=data-topbar-color][value=' + s.topbar.color + ']',
            )),
            (o = document.querySelector(
              'input[type=checkbox][name=data-menu-color][value=' + s.menu.color + ']',
            )),
            (r = document.querySelector(
              'input[type=checkbox][name=data-sidenav-size][value=' + s.sidenav.size + ']',
            )),
            (i = document.querySelector(
              'input[type=radio][name=data-layout-position][value=' + s.layout.position + ']',
            )),
