;(!(function (r) {
  ...
  ;((e.prototype.initCharts = function () {
    ...
    var e = ['#3e60d5', '#47ad77'],
      ...
      e =
        (new ApexCharts(document.querySelector('#widget-customers'), a).render(),
        ['#3e60d5', '#47ad77']),
      a = {
        chart: { height: 72, width: 72, type: 'donut' },
        legend: { show: !1 },
        ...
        series: [34, 66],
        dataLabels: { enabled: !1 },
        colors: (e = (t = r('#widget-orders').data('colors')) ? t.split(',') : e),
      },
      e =
      ...
      a = {
        ...
        series: [87, 13],
        dataLabels: { enabled: !1 },
        colors: (e = (t = r('#widget-revenue').data('colors')) ? t.split(',') : e),
      },
      e =
      ...
      a = {
        ...
        series: [45, 55],
        dataLabels: { enabled: !1 },
        colors: (e = (t = r('#widget-growth').data('colors')) ? t.split(',') : e),
      },
      e =
      ...
      a = {
        ...
        series: [23, 68],
        dataLabels: { enabled: !1 },
        colors: (e = (t = r('#widget-conversation').data('colors')) ? t.split(',') : e),
      },
      e =
        (new ApexCharts(document.querySelector('#widget-conversation'), a).render(),
      ...
      a = {
        ...
        colors: (e = (t = r('#revenue-chart').data('colors')) ? t.split(',') : e),
      ...
      a = {
        ...
        colors: (e = (t = r('#country-chart').data('colors')) ? t.split(',') : e),
        dataLabels: { enabled: !1 },
