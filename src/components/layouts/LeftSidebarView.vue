<template>
  <div class="leftside-menu" id="sidebarDashboards">
    ...
    <div class="button-close-fullsidebar" @click="$emit('close-sidebar')">
        ...
        <li class="side-nav-item">
          ...
          <div class="collapse" id="sidebarDashboards">
            <ul class="side-nav-second-level">
              ...
              <li><a href="/dashboard-products">Dashboard Product</a></li>
            </ul>
          </div>
        </li>
